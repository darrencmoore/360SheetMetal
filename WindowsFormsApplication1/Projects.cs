   ...
   commandString4);
        ...
        private void insrtprjbut_Click(object sender, EventArgs e)
        {
            ...
            commandString8);
                    ...
                    //Updated for SQL SERVER insert
                    string commandString66 = "INSERT INTO comm_job_type (cid, jid, bid, project_number, project_name, name_1, jtype_1, name_2, jtype_2, name_3, jtype_3, name_4, jtype_4) VALUES ('" + txtccid.Text.Trim() + "', '" + txtpjid.Text.Trim() + "', (SELECT SCOPE_IDENTITY()), '" + txtpjtnum.Text.Trim() + "', '" + txtPrjtName.Text.Trim() + "', '" + cbopjsestr.Text.Trim() + "', '" + "Estimator" + "', '" + cbopjssp.Text.Trim() + "', '" + "Salesperson" + "', '" + cboprjpm.Text.Trim() + "', '" + "ProjectManager" + "', '" + cbopjpa.Text.Trim() + "', '" + "ProjectManager" + "');";
