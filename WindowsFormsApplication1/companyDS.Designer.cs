...
namespace WindowsFormsApplication1.companyDSTableAdapters {
    ...
    public partial class companyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO `company` (`company_name`, `address`, `state`, `phone_number`, `conta" +
                "ct_person`) VALUES (@company_name, @address, @state, @phone_number, @contact_per" +
                "son)";
            ...
            this._commandCollection[2].CommandText = "SELECT address, cid, company_name, contact_person, phone_number, state FROM compa" +
                "ny WHERE (company_name = @company_name)";
        ...
        public virtual int Fill(companyDS.companyDataTable dataTable) {
        ...
        public virtual companyDS.companyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            companyDS.companyDataTable dataTable = new companyDS.companyDataTable();
        ...
        public virtual int FillCompany(companyDS.companyDataTable dataTable, string company_name) {
        ...
        public virtual companyDS.companyDataTable getCompany(string company_name) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((company_name == null)) {
                throw new global::System.ArgumentNullException("company_name");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(companyDS.companyDataTable dataTable) {
        ...
        public virtual int companyInsert(string company_name, string address, string state, string phone_number, string contact_person) {
            ...
            if ((contact_person == null)) {
                ...
                command.Parameters[4].Value = ((string)(contact_person));
            }
