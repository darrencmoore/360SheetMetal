            ...
            else
            {
                try
                {
                    ...
                    commandString5);
                        ...
                        //UPDATED FOR SQL SERVER INsert
                        string commandString6 = "INSERT INTO billing_received (jid, pid, project_number, psale_amt, pest_cost, pact_cost, payest_gp, payest_cost, est_gp, payact_gp, pbilling_cycle, pbilling_amt, pbilling_date, ppaid_amt, ppaid_date, chkd_actcost, bid) VALUES ('" + txtbjid.Text.Trim() + "', '" + txtbpid.Text.Trim() + "', '" + txtbpjtnum.Text.Trim() + "', '" + txtbpsaleamt.Text.Trim() + "', '" + txtbpestcost.Text.Trim() + "', '" + txtbpactcost.Text.Trim() + "', '" + txtPayEstGP.Text.Trim() + "', '" + txtPayEstCost.Text.Trim() + "', '" + txtbestgp.Text.Trim() + "', '" + txtActGP.Text.Trim() + "', '" + cbobillingnum.SelectedItem.ToString() + "', '" + txtbillingamt.Text.Trim() + "', '" + mskdtxtbillingDate.Text.Trim() + "', '" + txtPaidAmt.Text.Trim() + "', '" + mskdtxtpaidDate.Text.Trim() + "', 'T', LAST_INSERT_ID());";
                    ...
                    commandString2);
                        ...
                        //UPDATED FOR SQL SERVER INsert
                        string commandString1 = "INSERT INTO billing_received (jid, pid, project_number, psale_amt, pest_cost, pact_cost, payest_gp, payest_cost, est_gp, payact_gp, pbilling_cycle, pbilling_amt, pbilling_date, ppaid_amt, ppaid_date, bid) VALUES ('" + txtbjid.Text.Trim() + "', '" + txtbpid.Text.Trim() + "', '" + txtbpjtnum.Text.Trim() + "', '" + txtbpsaleamt.Text.Trim() + "', '" + txtbpestcost.Text.Trim() + "', '" + txtbpactcost.Text.Trim() + "', '" + txtPayEstGP.Text.Trim() + "', '" + txtPayEstCost.Text.Trim() + "', '" + txtbestgp.Text.Trim() + "', '" + txtActGP.Text.Trim() + "', '" + cbobillingnum.SelectedItem.ToString() + "', '" + txtbillingamt.Text.Trim() + "', '" + mskdtxtbillingDate.Text.Trim() + "', '" + txtPaidAmt.Text.Trim() + "', '" + mskdtxtpaidDate.Text.Trim() + "', LAST_INSERT_ID());";
                    ...
                    commandString90);
                        ...
                        foreach (DataRow dz in table90.Rows)
                        {
                            ...
                            if (dz["chkd_actcost"].ToString() == "T")
                            {
                                ...
                                string commandString76 = ("SELECT SUM(paid_amt as int) FROM billing WHERE project_number = '" + txtbpjtnum.Text.Trim() + "'");
                            ...
                            commandString76);
                                ...
                                txttlpdAmt.DataBindings.Add(new Binding("Text", table76, "SUM(paid_amt as int)", true));     // txttlpdAmt.DataBindings.Add(new Binding("Text", table76, "SUM(paid_amt)", true));                            
                                decimal pd2Amt;
                                decimal newpd2Amt;
                            ...
                            commandString91);
                                ...
                                txtbestpaidcomm.DataBindings.Clear();
                                txtbestpaidcomm.DataBindings.Add(new Binding("Text", table91, "SUM(estimator_comm)", true)); //"SUM(estimator_comm)"
                                decimal bestpaid2;
                                ...
                                txtbspcommpaid.DataBindings.Clear();
                                txtbspcommpaid.DataBindings.Add(new Binding("Text", table91, "SUM(salesperson_comm)", true)); // "SUM(salesperson_comm)"
                                decimal bsppaid2;
