        ...
        private void insrtbillingbut_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection MySqlConn = new SqlConnection(connectionString);
             ...
             commandString22);
                 ...
                 //txtbestname.Text = " ";
                 //txtbestcomm.Text = " ";
                 txtbestpaidcomm.Text = "0.00";
                 //cbobsperson.Text = " ";
                 //txtbsperson.Text = " ";
                 //txtbspcomm.Text = " ";
                 txtbspcommpaid.Text = "0.00";
                 //cbobpm.Text = " ";
                 //txtbprgmgr.Text = " ";
                 //txtbpgtmgrcomm.Text = " ";
                 txtbpmcommpaid.Text = "0.00";
                 //cbobpa.Text = " ";
                 //txtbpa.Text = " ";
                 //txtbpjtpacomm.Text = " ";
                 txtbpacommpaid.Text = "0.00";
                 txtPayEstCost.Text = " ";
                 txtbestgp.Text = " ";
                 txtPayEstGP.Text = " ";
                 //txtBPrjDesc.Text = " ";
       ...
       commandString100);
                ...
                if (txtbillingamt.Text != String.Empty )
                {
                    if (txtPaidAmt.Text == String.Empty)
                    {
                        ...
                        string commandString1 = "INSERT INTO billing_received (bid, jid, pid, project_number, psale_amt, pest_cost, pact_cost, payest_gp, payest_cost, est_gp, payact_gp, pbilling_cycle, pbilling_amt, pbilling_date, ppaid_amt, ppaid_date) VALUES ('" + txtbid.Text.Trim() + "', '" + txtbjid.Text.Trim() + "', '" + txtbpid.Text.Trim() + "', '" + txtbpjtnum.Text.Trim() + "', '" + txtbpsaleamt.Text.Trim() + "', '" + txtbpestcost.Text.Trim() + "', '" + txtbpactcost.Text.Trim() + "', '" + txtPayEstGP.Text.Trim() + "', '" + txtPayEstCost.Text.Trim() + "', '" + txtbestgp.Text.Trim() + "', '" + txtActGP.Text.Trim() + "', '" + cbobillingnum.SelectedItem.ToString() + "', '" + txtbillingamt.Text.Trim() + "', '" + mskdtxtbillingDate.Text.Trim() + "', '" + txtPaidAmt.Text.Trim() + "', '" + mskdtxtpaidDate.Text.Trim() + "');";
            ...
            else
            {
                try
                {
                    ...
                    commandString7);
                        ...
                        //UPDATED FOR SQL SERVER INsert
                        string commandString5 = "INSERT INTO billing (cid, pid, jid, project_name, project_number, billing_num, billing_amt, billing_date, estimator, estimator_percent, estimator_comm, salesperson, salesperson_percent, salesperson_comm, projectmgr, projectmgr_percent, projectmgr_comm, projectasst, projectasst_percent, projectasst_comm, project_saleamt, project_estcost, project_description, project_actcost, payest_gp, payest_cost, est_gp, payact_gp) VALUES ('" + txtbcid.Text.Trim() + "', '" + txtbpid.Text.Trim() + "', '" + txtbjid.Text.Trim() + "', '" + txtbpjtname.Text.Trim() + "', '" + txtbpjtnum.Text.Trim() + "', '" + cbobillingnum.SelectedItem.ToString() + "', '" + txtbillingamt.Text.Trim() + "', '" + mskdtxtbillingDate.Text.Trim() + "', '" + cbobestperson.Text.Trim() + "', '" + txtbestcomm.Text.Trim() + "', '" + txtbestpaidcomm.Text.Trim() + "', '" + cbobsperson.Text.Trim() + "', '" + txtbspcomm.Text.Trim() + "', '" + txtbspcommpaid.Text.Trim() + "', '" + cbobpm.Text.Trim() + "', '" + txtbpgtmgrcomm.Text.Trim() + "', '" + txtbpmcommpaid.Text.Trim() + "', '" + cbobpa.Text.Trim() + "', '" + txtbpjtpacomm.Text.Trim() + "', '" + txtbpacommpaid.Text.Trim() + "', '" + txtbpsaleamt.Text.Trim() + "', '" + txtbpestcost.Text.Trim() + "', '" + txtBPrjDesc.Text.Trim() + "', '" + txtbpactcost.Text.Trim() + "', '" + txtPayEstGP.Text.Trim() + "', '" + txtPayEstCost.Text.Trim() + "', '" + txtbestgp.Text.Trim() + "', '" + txtActGP.Text.Trim() + "');";
                    ...
                    commandString5);
                        ...
                        //UPDATED FOR SQL SERVER INsert
                        string commandString6 = "INSERT INTO billing_received (jid, pid, project_number, psale_amt, pest_cost, pact_cost, payest_gp, payest_cost, est_gp, payact_gp, pbilling_cycle, pbilling_amt, pbilling_date, ppaid_amt, ppaid_date, chkd_actcost, bid) VALUES ('" + txtbjid.Text.Trim() + "', '" + txtbpid.Text.Trim() + "', '" + txtbpjtnum.Text.Trim() + "', '" + txtbpsaleamt.Text.Trim() + "', '" + txtbpestcost.Text.Trim() + "', '" + txtbpactcost.Text.Trim() + "', '" + txtPayEstGP.Text.Trim() + "', '" + txtPayEstCost.Text.Trim() + "', '" + txtbestgp.Text.Trim() + "', '" + txtActGP.Text.Trim() + "', '" + cbobillingnum.SelectedItem.ToString() + "', '" + txtbillingamt.Text.Trim() + "', '" + mskdtxtbillingDate.Text.Trim() + "', '" + txtPaidAmt.Text.Trim() + "', '" + mskdtxtpaidDate.Text.Trim() + "', 'T', (SELECT SCOPE_IDENTITY()));";
                    ...
                    else
                    {
                        ...
                        //UPDATED FOR SQL SERVER INsert
                        string commandString2 = "INSERT INTO billing (cid, pid, jid, project_name, project_number, billing_num, billing_amt, billing_date, estimator, estimator_percent, estimator_comm, salesperson, salesperson_percent, salesperson_comm, projectmgr, projectmgr_percent, projectmgr_comm, projectasst, projectasst_percent, projectasst_comm, project_saleamt, project_estcost, project_description, project_actcost, payest_gp, payest_cost, est_gp, payact_gp, paid_stmt) VALUES ('" + txtbcid.Text.Trim() + "', '" + txtbpid.Text.Trim() + "', '" + txtbjid.Text.Trim() + "', '" + txtbpjtname.Text.Trim() + "', '" + txtbpjtnum.Text.Trim() + "', '" + cbobillingnum.SelectedItem.ToString() + "', '" + txtbillingamt.Text.Trim() + "', '" + mskdtxtbillingDate.Text.Trim() + "', '" + cbobestperson.Text.Trim() + "',  '" + txtbestcomm.Text.Trim() + "', '" + txtbestpaidcomm.Text.Trim() + "', '" + cbobsperson.Text.Trim() + "', '" + txtbspcomm.Text.Trim() + "', '" + txtbspcommpaid.Text.Trim() + "', '" + cbobpm.Text.Trim() + "', '" + txtbpgtmgrcomm.Text.Trim() + "', '" + txtbpmcommpaid.Text.Trim() + "', '" + cbobpa.Text.Trim() + "', '" + txtbpjtpacomm.Text.Trim() + "', '" + txtbpacommpaid.Text.Trim() + "', '" + txtbpsaleamt.Text.Trim() + "', '" + txtbpestcost.Text.Trim() + "', '" + txtBPrjDesc.Text.Trim() + "', '" + txtbpactcost.Text.Trim() + "', '" + txtPayEstGP.Text.Trim() + "', '" + txtPayEstCost.Text.Trim() + "', '" + txtbestgp.Text.Trim() + "', '" + txtActGP.Text.Trim() + "', 'N');";
                    ...
                    commandString2);
                        ...
                        //UPDATED FOR SQL SERVER INsert
                        string commandString1 = "INSERT INTO billing_received (jid, pid, project_number, psale_amt, pest_cost, pact_cost, payest_gp, payest_cost, est_gp, payact_gp, pbilling_cycle, pbilling_amt, pbilling_date, ppaid_amt, ppaid_date, bid) VALUES ('" + txtbjid.Text.Trim() + "', '" + txtbpid.Text.Trim() + "', '" + txtbpjtnum.Text.Trim() + "', '" + txtbpsaleamt.Text.Trim() + "', '" + txtbpestcost.Text.Trim() + "', '" + txtbpactcost.Text.Trim() + "', '" + txtPayEstGP.Text.Trim() + "', '" + txtPayEstCost.Text.Trim() + "', '" + txtbestgp.Text.Trim() + "', '" + txtActGP.Text.Trim() + "', '" + cbobillingnum.SelectedItem.ToString() + "', '" + txtbillingamt.Text.Trim() + "', '" + mskdtxtbillingDate.Text.Trim() + "', '" + txtPaidAmt.Text.Trim() + "', '" + mskdtxtpaidDate.Text.Trim() + "', (SELECT SCOPE_IDENTITY()));";
                    ...
                    commandString90);
                        ...
                        foreach (DataRow dz in table90.Rows)
                        {
                            ...
                            if (dz["chkd_actcost"].ToString() == "T")
                            {
                                ...
                                string commandString76 = ("SELECT SUM(CAST(paid_amt as decimal(10,2))) as paidtotal FROM billing WHERE project_number = '" + txtbpjtnum.Text.Trim() + "'");
                            ...
                            commandString76);
                                ...
                                txttlpdAmt.DataBindings.Add(new Binding("Text", table76, "paidtotal", true));     // txttlpdAmt.DataBindings.Add(new Binding("Text", table76, "SUM(paid_amt)", true));                            
                                decimal pd2Amt;
                                decimal newpd2Amt;
                                ...
                                //removed 5/24/2016 to get the total paid amount correct
                                ...
                                string commandString911 = ("SELECT SUM(CAST(estimator_comm as decimal(10,2))) as estimatorCommTotal FROM billing WHERE project_number = '" + txtbpjtnum.Text.Trim() + "'");
                                SqlCommand mysqlcommand911 = new SqlCommand(commandString911, MySqlConn);

                                    DataTable table911 = GetDataTable(
                                // Pass open database connection to function
                                ref MySqlConn,
                                // Pass SQL statement to create SqlDataReader
                                commandString911);

                                string commandString922 = ("SELECT SUM(CAST(salesperson_comm as decimal(10,2))) as salespersonCommTotal FROM billing WHERE project_number = '" + txtbpjtnum.Text.Trim() + "'");
                                SqlCommand mysqlcommand922 = new SqlCommand(commandString922, MySqlConn);

                                DataTable table922 = GetDataTable(
                            // Pass open database connection to function
                            ref MySqlConn,
                            // Pass SQL statement to create SqlDataReader
                            commandString922);

                                string commandString933 = ("SELECT SUM(CAST(projectmgr_comm as decimal(10,2))) as projectmgrCommTotal FROM billing WHERE project_number = '" + txtbpjtnum.Text.Trim() + "'");
                                SqlCommand mysqlcommand933 = new SqlCommand(commandString933, MySqlConn);

                                DataTable table933 = GetDataTable(
                            // Pass open database connection to function
                            ref MySqlConn,
                            // Pass SQL statement to create SqlDataReader
                            commandString933);

                                string commandString944 = ("SELECT SUM(CAST(projectasst_comm as decimal(10,2))) as projectasstCommTotal FROM billing WHERE project_number = '" + txtbpjtnum.Text.Trim() + "'");
                                SqlCommand mysqlcommand944 = new SqlCommand(commandString944, MySqlConn);

                                DataTable table944 = GetDataTable(
                            // Pass open database connection to function
                            ref MySqlConn,
                            // Pass SQL statement to create SqlDataReader
                            commandString944);
                                ...
                                txtbestpaidcomm.DataBindings.Clear();
                                txtbestpaidcomm.DataBindings.Add(new Binding("Text", table911, "estimatorCommTotal", true)); //"SUM(estimator_comm)"
                                decimal bestpaid2;
                                ...
                                txtbspcommpaid.DataBindings.Clear();
                                txtbspcommpaid.DataBindings.Add(new Binding("Text", table922, "salespersonCommTotal", true)); // "SUM(salesperson_comm)"
                                decimal bsppaid2;
                                ...
                                txtbpmcommpaid.DataBindings.Clear();
                                txtbpmcommpaid.DataBindings.Add(new Binding("Text", table933, "projectmgrCommTotal", true));
                                decimal bpmpaid2;
                                ...
                                txtbpacommpaid.DataBindings.Clear();
                                txtbpacommpaid.DataBindings.Add(new Binding("Text", table944, "projectasstCommTotal", true));
                                decimal bpapaid2;
                            ...
                            commandString7);
                                ...
                                string commandString4 = ("SELECT SUM(CAST(paid_amt as decimal(10,2))) as paidtotal FROM billing WHERE project_number = '" + txtbpjtnum.Text.Trim() + "'");
                            ...
                            commandString4);
                                ...
                                txttlpdAmt.DataBindings.Clear();
                                txttlpdAmt.DataBindings.Add(new Binding("Text", table4, "paidtotal", true)); 
                            ...
                            //commandString5);
                                ...
                                DataTable table9511 = GetDataTable(
                            // Pass open database connection to function
                            ref MySqlConn,
                            // Pass SQL statement to create SqlDataReader
                            commandString911);
                                ...
                                DataTable table9522 = GetDataTable(
                            // Pass open database connection to function
                            ref MySqlConn,
                            // Pass SQL statement to create SqlDataReader
                            commandString922);
                                ...
                                DataTable table9533 = GetDataTable(
                            // Pass open database connection to function
                            ref MySqlConn,
                            // Pass SQL statement to create SqlDataReader
                            commandString933);
                                ...
                                DataTable table9544 = GetDataTable(
                            // Pass open database connection to function
                            ref MySqlConn,
                            // Pass SQL statement to create SqlDataReader
                            commandString944);
                                ...
                                txtbestpaidcomm.DataBindings.Clear();
                                txtbestpaidcomm.DataBindings.Add(new Binding("Text", table9511, "estimatorCommTotal", true));
                                decimal bestpaid;
                                ...
                                txtbspcommpaid.DataBindings.Clear();
                                txtbspcommpaid.DataBindings.Add(new Binding("Text", table9522, "salespersonCommTotal", true));
                                decimal bsppaid;
                                ...
                                txtbpmcommpaid.DataBindings.Clear();
                                txtbpmcommpaid.DataBindings.Add(new Binding("Text", table9533, "projectmgrCommTotal", true));
                                decimal bpmpaid;
                                ...
                                txtbpacommpaid.DataBindings.Clear();
                                txtbpacommpaid.DataBindings.Add(new Binding("Text", table9544, "projectasstCommTotal", true));
                                decimal bpapaid;
